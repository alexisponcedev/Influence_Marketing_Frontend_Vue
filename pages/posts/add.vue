...
export default class PostForm extends Vue {
        ...
        if (this.formValidate()) {
            if (this.editMode)
                await Api.Post.update({
                    ...
                    Api.Page.get(this.Post.page!.id).then(() => {
                        Api.Page.update({
                            Page: this.Post.page!,
                            id: +this.Post.page!.id!,
                        }).then((page) => {
                ...
                await Api.Post.create(this.Post)
                    .then((post: any) => {
                        ...
                        Api.Page.create(this.Post.page!).then(
                            Api.Page.doDeploy
                        );
                        return post;
                    })
    ...
    get liveWebsite() {
        return this.liveWebsiteUrl + (this.Post.page!.route || "");
    }
    ...
    postTitleChanged() {
        ...
        if (this.Post.page!.route && this.Post.page!.route !== "") {
            ...
            parentRoute = this.Post.page!.route!.substring(
                0,
