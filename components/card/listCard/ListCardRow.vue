<template>
  <base-card>
    <v-card-text>
      <div class="d-flex justify-space-between align-center flex-wrap m-3">
        <div class="flex-1 d-flex align-center mr-4">
          <v-avatar>
            <img :src="avatar" alt="John" class="mr-2" />
          </v-avatar>
        ...
        <div class="flex-1">
          <div class="d-flex justify-space-between">
            <p class="ma-0">Profile Completion</p>
            <p class="ma-0">40%</p>
          </div>
          <v-progress-linear value="15" :color="progressbarColor" />
        </div>
        <div class="flex-1 text-right px-6">
          ...
          <p class="ma-0">
            <a href="#" class="font-weight-medium grey--text">
              <v-icon class="body-1" color="blue lighten-1">mdi-twitter</v-icon>
              ui-lib
            </a>
          </p>
        </div>
