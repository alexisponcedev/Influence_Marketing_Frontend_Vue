<template>
  ...
  <div class="tw-p-2">
    <button class="tw-bg-white tw-w-full tw-h-14 tw-border tw-border-solid tw-border-gray-400 tw-rounded hover:tw-bg-green-300 hover:tw-bg-opacity-30 " @click="enableSelectMode">
      <span v-if="model.value" class="tw-text-green-400">{{model.value}}</span>
