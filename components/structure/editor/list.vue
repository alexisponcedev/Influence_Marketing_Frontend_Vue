<template>
  <div class="tw-p-2 tw-rounded-lg ">
    ...
    <div class="tw-mb-4">
      <draggable v-model="model.value" group="people" @start="drag=true" @end="drag=false">
    ...
    <button class="tw-text-center tw-px-3 tw-font-bold tw-py-3 tw-rounded-lg tw-bg-green-300 tw-w-full" @click="addNew">
      Add new item
    </button>
  </div>
