<template>
  <div>
    ...
    <div v-if="table.enable"
      ...
      <button @click="addTable" class="tw-px-1 tw-text-blue-500">Insert</button>
      <button @click="table.enable = false" class="tw-px-1 tw-text-red-500">cancel</button>
    </div>
    ...
    <div v-if="color.enable"
      ...
      <button @click="color.enable = false" class="tw-px-1 tw-text-red-500">cancel</button>
    </div>
  ...
  data() {
    return {
      color: {
        enable: false,
        items: [
          "#00AAA6", "#00CCCC", "#000000", "#101010", "#252525", "#FFFFFF",
          "#EAEAEA", "#D9D9D9", "#F6F7FD", "#9747FF", "#1E518A", "#0C4955",
          "#ffbbf3", "#2b0038"
        ],
        value: ''
      },
