<template>
    <div>
        <div v-if="placeholder">
            <div
                class="tw-flex tw-items-center tw-space-x-3 tw-border tw-border-solid tw-border-gray-200 tw-rounded-xl tw-p-1.5 hover:tw-bg-gray-100 tw-cursor-pointer tw-animate-pulse">
