<template>
    <v-col class="py-0" v-bind="field.colAttrs">
        ...
        <v-select v-model="model" outlined @change="onChanged" :rules="field.rules" :item-text="field['item-text']"
                  :item-value="field['item-value']" :placeholder="field.placeholder"
                  :items="typeof field.items === 'function' ? field.items() : field.items" :loading="
