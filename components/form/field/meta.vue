  ...
  <div class="tw-grid tw-grid-cols-3 tw-gap-2" v-if="model.meta && model.meta.length > 0">
    <div class="tw-space-y-1.5">
      ...
      <div class="tw-p-2 tw-rounded-lg tw-bg-white tw-space-y-2">
        ...
        <div>
          <div v-if="googleTitleIndex >= 0" class="tw-text-blue-600">{{ model.meta[googleTitleIndex].content }}</div>
    ...
    <div class="tw-space-y-1.5">
      ...
      <div class="tw-p-2 tw-rounded-lg tw-bg-white tw-space-y-2">
        ...
        <div class="tw-border tw-border-solid tw-border-gray-200 tw-bg-gray-50">
          <img v-if="ogImageIndex > 0 && model.meta[ogImageIndex].content" :src="model.meta[ogImageIndex].content"
               alt="Meta Image">

          <div class="tw-p-2">
            <div v-if="ogUrlIndex > 0" class="tw-text-gray-500 tw-font-sm">{{ model.meta[ogUrlIndex].content }}</div>
      ...
      <div v-if="ogUrlIndex >= 0"
        ...
        <input type="text" placeholder="Enter url" class="x-input tw-flex-1" v-model="model.meta[ogUrlIndex].content"/>
      </div>
