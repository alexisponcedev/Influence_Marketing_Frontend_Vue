<template>
    <v-col class="py-0" v-bind="field.colAttrs">
        ...
        <div class="tw-flex tw-flex-warp tw-gap-2 tw-items-center tw-w-full " style="flex-wrap: wrap;">
            <div
                class="tw-bg-white tw-px-2 tw-py-0.5 tw-rounded tw-border tw-border-solid tw-border-gray-500 tw-whitespace-nowrap ">
                <input type="text" class="x-input" placeholder="Enter name" v-model='name'
                       @keyup.enter.prevenet="addTag">
