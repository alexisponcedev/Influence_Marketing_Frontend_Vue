        ...
        <v-card-text>
            <v-row>
                ...
                <v-col cols="2" class="py-0 pb-6 word-wrap-break-word">
                    <button
                        class="tw-p-3.5 tw-bg-gray-100 tw-rounded tw-border tw-border-gray-200 tw-border-solid"
            ...
            <div
                class="tw-space-y-2 tw-max-h-80 tw-overflow-y-auto no-scrollbar"
            >
                <template-item
                    v-for="template in Api.Template.all"
                    :key="template.id"
                    :template="template"
                    @selected="selected"
                />
