...
export default class BlockMoreTvAmericaBox extends Vue {
  ...
  reset() {
    this.model = {
      ...
      subtitle: {
        id: 3, type: StructureType.String, title: 'little Title', value: 'America wants less talk and more TV'
      },
      image: {
        id: 4,
      ...
      list: {
        ...
        newItem: {
          ...
          note: { id: 3, type: StructureType.String, title: 'Note', value: 'Think most advertising these days is nonsense' },
        },
        value: [
          {
            chart: {
          ...
          },
          {
            ...
            note: { id: 3, type: StructureType.String, title: 'Note', value: 'Believe a brand should invest in products not pretentious artsy advertisement' },
          },
          {
            chart: {
              id: 0,
            ...
            note: { id: 3, type: StructureType.String, title: 'Note', value: 'People look for great value over a brand\'s "purpose" when purchasing a new TV' },
          },
          {
            chart: {
              id: 0,
            ...
            note: { id: 3, type: StructureType.String, title: 'Note', value: 'Think there\'s way too much advertising these days (sorry about that!)' },
          }
        ]
      }
