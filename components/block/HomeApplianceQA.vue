...
export default class BlockHomeApplianceQA extends Vue {
    ...
    reset(){
      this.model = {
        ...
        text: {id: 4, type: StructureType.Text, title: 'Text', value: 'If you would like to know more about our products, simply click here to visit our support and FAQ pages.'},
