...
export default class BlockProductStaticContent extends Vue {
    ...
    reset(){
      this.model = {
        ...
        paragraph: {
          id: 2, type: StructureType.String, title: 'Paragraph', value: 'The 2022 U7 delivers premium upgrades that offer exceptional performance for gamers and non-gamers alike including: IMAX enhanced, Filmmaker Mode, Dolby Vision IQ, HDR10, HDR10+, HDR 10+ Adaptive, Quantum Dot Color, FreeSync, and NEXTGEN TV ATSC 3.0. Premium audio upgrades including Dolby Atmos, eARC, and WiSA deliver immersive audio, while the 120Hz refresh rate brings incredible fluidity and clarity to fast-action content. The 2021 U7 exceeded expectations and the 2022 U7 is poised to take it to a whole new level.'
        },
      }
    }
    mounted() {
