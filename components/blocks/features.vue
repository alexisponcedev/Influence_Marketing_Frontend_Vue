        ...
        <div class="tw-flex tw-items-center tw-flex-col tw-justify-center tw-bg-[#E7ECFE] tw-py-6" v-if="model.template.value === 'v1'">
            ...
            <div class="tw-flex tw-p-10">
                <div class="tw-flex tw-flex-col tw-items-center tw-py-[50px] tw-px-[60px] tw-relative tw-bg-white hover:tw-scale-[1.07] hover:tw-bg-[#1954ED] tw-group tw-ransition tw-ease-in-out hover:-tw-translate-y-1 tw-duration-300 hover:tw-z-20">
                    <h2 class="tw-text-[24px] tw-font-bold tw-mb-[13px] group-hover:tw-text-white tw-z-10">{{ model.leftBoxTitle.value }}</h2>
                    <div v-html="model.leftBoxValue.value" class="tw-text-sm group-hover:tw-text-white tw-z-10"/>
                    <img src="blocks/feature.svg" alt="" class="tw-absolute tw-top-0 tw-bottom-0 tw-right-0 tw-left-0 tw-opacity-0 group-hover:tw-opacity-100">
                </div>
                <div class="tw-flex tw-flex-col tw-items-center tw-py-[50px] tw-px-[60px] tw-relative tw-bg-white hover:tw-scale-[1.07] hover:tw-bg-[#1954ED] tw-group tw-ransition tw-ease-in-out hover:-tw-translate-y-1 tw-duration-300 hover:tw-z-20">
                    <h2 class="tw-text-[24px] tw-font-bold tw-mb-[13px] group-hover:tw-text-white tw-z-10">{{ model.centerBoxTitle.value }}</h2>
                    <div v-html="model.centerBoxValue.value" class="tw-text-sm group-hover:tw-text-white tw-z-10"/>
                    <img src="blocks/feature.svg" alt="" class="tw-absolute tw-top-0 tw-bottom-0 tw-right-0 tw-left-0 tw-opacity-0 group-hover:tw-opacity-100">
                </div>
                <div class="tw-flex tw-flex-col tw-items-center tw-py-[50px] tw-px-[60px] tw-relative tw-bg-white hover:tw-scale-[1.07] hover:tw-bg-[#1954ED] tw-group tw-ransition tw-ease-in-out hover:-tw-translate-y-1 tw-duration-300 hover:tw-z-20">
                    <h2 class="tw-text-[24px] tw-font-bold tw-mb-[13px] group-hover:tw-text-white tw-z-10">{{ model.rightBoxTitle.value }}</h2>
                    <div v-html="model.rightBoxValue.value" class="tw-text-sm group-hover:tw-text-white tw-z-10"/>
                    <img src="blocks/feature.svg" alt="" class="tw-absolute tw-top-0 tw-bottom-0 tw-right-0 tw-left-0 tw-opacity-0 group-hover:tw-opacity-100">
                </div>
            </div>
        </div>
        ...
        <div class="tw-flex tw-items-center tw-flex-col tw-justify-center tw-bg-[#E7ECFE] tw-py-6" v-else>
            ...
            <div class="tw-flex tw-gap-2 tw-p-10">
                <div class="tw-flex tw-flex-col tw-items-center tw-py-[50px] tw-px-[60px] tw-bg-white">
                    <h2 class="tw-text-[24px] tw-font-bold tw-mb-[13px] group-hover:tw-text-white">{{ model.leftBoxTitle.value }}</h2>
                    <div v-html="model.leftBoxValue.value" class="tw-text-sm group-hover:tw-text-white"/>
                </div>
                <div class="tw-flex tw-flex-col tw-items-center tw-py-[50px] tw-px-[60px] tw-bg-white">
                    <h2 class="tw-text-[24px] tw-font-bold tw-mb-[13px] group-hover:tw-text-white">{{ model.centerBoxTitle.value }}</h2>
                    <div v-html="model.centerBoxValue.value" class="tw-text-sm group-hover:tw-text-white"/>
                </div>
                <div class="tw-flex tw-flex-col tw-items-center tw-py-[50px] tw-px-[60px] tw-bg-white">
                    <h2 class="tw-text-[24px] tw-font-bold tw-mb-[13px] group-hover:tw-text-white">{{ model.rightBoxTitle.value }}</h2>
                    <div v-html="model.rightBoxValue.value" class="tw-text-sm group-hover:tw-text-white"/>
                </div>
            </div>
        </div>
    </div>
