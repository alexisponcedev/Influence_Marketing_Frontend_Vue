<template>
    <div>
        <img src="/blocks/ProductsHeading.png" alt="">
    </div>
</template>
...
@Component
export default class ProductsHeading extends Vue {
    ...
    mounted() {
        ...
        blockAddItem(this.model, 'title', {id: 2, type: StructureType.String, title: 'Title', value: 'Televisions'})
