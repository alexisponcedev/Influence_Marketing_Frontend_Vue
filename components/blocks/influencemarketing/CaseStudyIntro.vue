<template>
    <section v-if="!isEmpty">
        <div class="tw-bg-midnight">
            ...
            >
                <div
                    class="tw-w-full md:tw-w-1/2 tw-flex tw-flex-col tw-justify-center tw-items-start tw-gap-6 md:tw-gap-8"
                >
                    <div
                        class="tw-flex tw-flex-col tw-justify-center tw-items-start tw-gap-4 md:tw-gap-6"
                    >
                        <h1
                            v-if="model.title.value"
                    ...
                    <div
                        v-if="model?.note?.value"
                        class="tw-text-gray-200 tw-text-xs tw-font-normal"
                        v-html="model?.note?.value"
                    ></div>
                </div>
                <div class="tw-w-full md:tw-w-1/2">
                    <div
                        v-if="model?.description?.value"
