...
export default class CESPX1ImageAndText extends Vue {
  ...
  reset() {
    this.model = {
      text : {id : 0 , type : StructureType.Text , title : 'Text' , value : '<h2>The PX1-PRO features the award-winning triChroma laser engine to achieve full coverage of the BT.2020 color space for a true-to-life picture.</h2>' +
